...
date: 2023-03-24
category: log
description: 德州扑克 Web 小游戏的开发记录：想法来源、架构与技术栈、遇到的问题与未来改进。
...
　　后续在更新的时候，需要中途接入 git 来管理版本；之后也可能会开源代码供读者们评判。
...
　　希望读者们也能不时在自己喜欢的领域做这样的尝试：从生活中发现问题，分析需求并用自己所学的知识来解决问题。同时分析自己构建整个过程中遇到的问题和改进方式，给出自己的思考。
